...
![webMVSC](img/web.jpg "Página web de descarga Microsoft Visual Studio Community 2019")
...
![instalacionMVSC](img/ainstalar.jpg "Opción a instalar")
...
![webgit](img/webgit.jpg "Página web de descarga de Git")
...
![webfivem](img/webfivem.jpg "Página web de descarga de FiveM")
...
![consola](img/consola.jpg "Consola")
...
![localhost](img/localhost.jpg "Localhost")
...
![localhost](img/localhost1.jpg "Pantalla espera")
...
![nuevo proyecto](img/nuevoproyecto.jpg "Crear nuevo proyecto")

Tras darle a siguien, buscamos **biblioteca de clases (.NET Framework)** y la escogemos:

![biblioteca de clases](img/bibliotecaclases.jpg "Biblioteca de clases")

En la siguiente pantalla indicamos la configuración que deseemos:

![nombre del proyecto](img/nombreproyecto.jpg "Nombre del proyecto")
...
![citizenfxcore](img/citizenfxcore.jpg "DLL CitizenFX.Core")
...
![release](img/release.jpg "Release")

Y compilaremos la solución:

![compile](img/compile.jpg "Compile")
...
![compiled](img/compiled.jpg "Compiled")
...
![class library](img/classlibrary.jpg "Class Library")
...
![coche](img/coche.jpg "Spawn coche")
